<li class="m-menu__item m-menu__item--submenu {{in_array(Route::current()->getName(), ['terms']) ? 'm-menu__item--expanded m-menu__item--open' : ''}}" aria-haspopup="true" m-menu-submenu-toggle="hover">
    <a href="javascript:void(0)" class="m-menu__link m-menu__toggle">
        <i class="m-menu__link-icon fa fa-project-diagram"></i>
            <span class="m-menu__link-text">Taxonomy</span>
