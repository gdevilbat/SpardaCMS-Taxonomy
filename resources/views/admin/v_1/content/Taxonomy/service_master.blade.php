        ...
        <div class="dropdown-menu dropdown-menu-left">
            @can('update-taxonomy', $taxonomy)
                <button class="dropdown-item" type="button">
                    <a class="m-link m-link--state m-link--info" href="{{action('\Gdevilbat\SpardaCMS\Modules\Taxonomy\Http\Controllers\TaxonomyController@create').'?code='.encrypt($taxonomy->getKey())}}"><i class="fa fa-edit"> Edit</i></a>
                </button>
            @endcan
